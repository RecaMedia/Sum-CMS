...
if($log_ID==1 && $log_Role=='admin' && isset($_POST['id']) && $_POST['id'] != '' && preg_match("/^[0-9]+$/", $_POST['id'])){
	$DBLink = MySqlConnect();
	$UserID = mysql_escape_string($_POST['id']);
	if(mysql_query("UPDATE IDCMS_Authors SET Active='0' WHERE ID='$UserID' LIMIT 1",$DBLink)){
